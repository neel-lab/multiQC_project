...
<p> wsl --install</p>
<p>Install Ubuntu, from “Microsoft Store” in start menu. Just look for ubuntu, rather than any specific version.</p>p>
<p>Reboot, open Ubuntu (WSL) terminal, then install STAR and FASTQC:</p>p>
<p>  sudo apt update</p>
<p>  sudo apt install rna-star fastqc</p>p>
...
<p>MultiQC is run at python terminal to install multiqc:</p>p>
